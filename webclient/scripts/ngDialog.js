				...
				var publicMethods = {
					...
					open: function (opts) {
						...
						$q.when(loadTemplate(options.template || options.templateUrl)).then(function (template) {
							...
							$dialog.html('<div class="ngdialog-overlay"></div><div class="ngdialog-content" ng-style="{left: divleft, top: divtop}" draggable xpos="divleft" ypos="divtop">' + template + '</div>');
